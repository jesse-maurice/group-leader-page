...
const Header = ({lang, setLang}) => {
  return (
    <>
      <div className="flex flex-row lg:px-[140px] max-sm:px-5 md:px-10 pt-[20px] absolute  items-center justify-between w-full ">
        ...
        <div>
          ...
          ></input>
          <i class="fa-sharp fa-solid fa-magnifying-glass max-sm:hidden relative right-[25px] top-[1px]"></i>
